...
curl -u wazuh-integration:REDACTED_NTFY_PW \
...
Login: admin / REDACTED_INDEXER_PW

### 3c. Verify manager API

```bash
curl -k -u wazuh-wui:REDACTED_API_PW https://192.168.1.242:55000/
...
| Wazuh Dashboard | http://wazuh.enigmata.local | admin / REDACTED_INDEXER_PW |
| Wazuh API | https://192.168.1.242:55000 | wazuh-wui / REDACTED_API_PW |
